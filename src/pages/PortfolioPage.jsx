...
const Icon = ({ name, className = "w-4 h-4" }) => {
  const icons = {
    ...
    chartLine:      <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>,
    ...
    shield:         <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>,
    arrowUp:        <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}><path strokeLinecap="round" strokeLinejoin="round" d="M5 10l7-7 7 7M12 3v18" /></svg>,
    ...
    arrowRight:     <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><line x1="5" y1="12" x2="19" y2="12" /><polyline points="12,5 19,12 12,19" /></svg>,
    dot:            <svg className={className} viewBox="0 0 8 8"><circle cx="4" cy="4" r="4" fill="currentColor" /></svg>,
  };
...
const overviewItems = [
  ...
  { iconName: "globe",      title: "Multi-Origin Supply Chain",          body: "Sourcing from China, India, Pakistan, UAE and beyond — with 76 international partners providing diversified procurement access.",                                          badge: "China · India · UAE · Pakistan" },
...
const OverviewSection = () => (
  <section className="bg-[#f0f4f9] px-4 py-14 sm:px-6">
    <div className="mx-auto max-w-7xl">
      ...
      />
      {/* items-stretch → all cards in each row same height */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 items-stretch">
        {overviewItems.map((item, i) => (
          <FadeIn key={i} delay={i * 80}>
            {/* flex flex-col → line always at very bottom */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 items-stretch">
        {portfolioItems.map((item, index) => (
          <FadeIn key={index} delay={index * 100}>
            {/* flex flex-col → stats footer + line always at very bottom */}
            <div className="group flex flex-col h-full overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              {/* Stats bar always above the accent line */}
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch">
        {businessModels.map((m, i) => (
          <FadeIn key={i} delay={i * 80}>
            {/* flex flex-col so the return number is always at the bottom */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-stretch">
        {supplierItems.map((s, i) => (
          <FadeIn key={i} delay={i * 100}>
            {/* flex flex-col h-full → equal heights */}
